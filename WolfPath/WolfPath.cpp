...
struct InspectorView : ui::Buildable
{
	void Build() override
	{
		...
		ui::imLabel("FOV"), ui::imEditFloat(cameraFOV);
		ui::imLabel("Position"), ui::imEditFloatVec(&cameraPos.x, ui::axesXYZ);
		ui::imLabel("Direction"), ui::imEditFloatVec(&cameraDir.x, ui::axesXYZ);
