...
{
	GLCHK(glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, !(flags & TF_NOFILTER) ? GL_LINEAR : GL_NEAREST));
	GLCHK(glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, !(flags & TF_NOFILTER) ? GL_LINEAR : GL_NEAREST));
